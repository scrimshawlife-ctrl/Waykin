...
See the complete [`Current Capability Matrix`](docs/canonical/CURRENT_CAPABILITY_MATRIX.md). AR redesign planning (supporting only): [`AR Product Redesign Map`](docs/design/AR_PRODUCT_REDESIGN_MAP.md) · long-term [`North Star`](docs/design/PRODUCT_VISION_NORTH_STAR.md) · [`MVP → Vision Ladder`](docs/canonical/MVP_TO_VISION_LADDER.md).
...
**Proprietary** — Copyright (c) 2024–2026 **Zero State** / **Zero State LLC**.  
