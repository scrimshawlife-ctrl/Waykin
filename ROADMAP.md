...
> **North star (reference only):** [`docs/design/PRODUCT_VISION_NORTH_STAR.md`](docs/design/PRODUCT_VISION_NORTH_STAR.md) — AR companion across walks/runs/rides + fitness; later worldbuilding and user-designed companions/experiences. Gated path: [`docs/canonical/MVP_TO_VISION_LADDER.md`](docs/canonical/MVP_TO_VISION_LADDER.md). This roadmap remains evidence-gated engineering for the **current** binding MVP.
