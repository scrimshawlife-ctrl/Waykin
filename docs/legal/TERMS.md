...
```yaml
document_id: WAYKIN-LEGAL-TERMS
version: 1.0
date: 2026-07-20
...
**Not turn-by-turn navigation authority.** Any map or route guide is **presentation only** unless a future product explicitly ships certified navigation.

## 3. Outdoor safety

You are responsible for your surroundings. See [SAFETY.md](SAFETY.md).  
You may pause or end a session at any time; stopping is never framed as failure.
...
## 5. Accounts and network services

MVP local builds may operate **without** a Waykin account. Future online features (if any) will have additional terms.
...
Apple, HealthKit, MapKit, ARKit, RealityKit, and other platform names are trademarks of their respective owners. Use of those frameworks is subject to Apple’s terms and guidelines.

## 9. Changes

Terms may be updated in-repo. Continued use after a published update constitutes acceptance where permitted by law.
