...
Last updated: 2026-07-25 (main `7089b5d` — Phase A PASS; device + TF human lane)
...
|---|---|---|---|
| Issue #41 — outdoor / physical validation | Human device | **Parked / PARTIAL** — daylight re-walk on tip `7089b5d` (or ≥ `3cc8ac2` with same binary identity) | [DEFERRED_RECOMMENDATIONS.md](../design/DEFERRED_RECOMMENDATIONS.md) · [OUTDOOR_QA_RECEIPT_20260725T194535Z_3cc8ac2_PENDING.md](../design/receipts/OUTDOOR_QA_RECEIPT_20260725T194535Z_3cc8ac2_PENDING.md) |
...
| Field | Value |
|---|---|
| `main` tip (full) | `7089b5da0256e5aa9e37a1539eb70d64d6506a15` |
| `main` tip (short) | `7089b5d` |
...
| Work | Evidence |
|---|---|
| Phase A + device/TF handoff receipts | PR #239 · main `7089b5d` |
...
1. **Connect iPhone** → install Debug tip `7089b5d` → indoor I1–I12 → `evidence_class: OBSERVED` (note indoor).
...
```text
Main tip: 7089b5d · version 0.9.0 (2)
